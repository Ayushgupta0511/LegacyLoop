            ...
            if (filteredByRoute.length > 0) {
                ...
                const fallbacks = {
                    ...
                    electronics: [
                        ...
                        { id: 'fb-e2', title: 'USB-C Hub 7-in-1', description: 'HDMI, USB 3.0 x3, SD card. Essential for Mac users.', price: 900, isFree: false, condition: 'new', images: ['https://images.unsplash.com/photo-1625842268584-8f3296236761?w=400&h=300&fit=crop'], sellerName: 'Aditya N.', sellerYear: '2nd Year' },
                    ...
                    kitchen: [
                        { id: 'fb-k1', title: 'Electric Kettle 1.5L', description: 'Boils water super fast. Used for one semester.', price: 300, isFree: false, condition: 'like-new', images: ['https://images.unsplash.com/photo-1585515320310-259814833e62?w=400&h=300&fit=crop'], sellerName: 'Ananya S.', sellerYear: '2nd Year' },
                        ...
                        { id: 'fb-k3', title: 'Mini Induction Cooktop', description: 'Portable 1200W plate. Perfect for hostel cooking.', price: 800, isFree: false, condition: 'good', images: ['https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&h=300&fit=crop'], sellerName: 'Rohan V.', sellerYear: '3rd Year' },
                    ...
                    dorm: [
                        { id: 'fb-d1', title: 'Desk Lamp – LED Adjustable', description: 'USB powered, 3 brightness levels. Great for study.', price: 350, isFree: false, condition: 'like-new', images: ['https://images.unsplash.com/photo-1507473885765-e6ed057ab6fe?w=400&h=300&fit=crop'], sellerName: 'Siddharth L.', sellerYear: '2nd Year' },
                    ...
                    hobbies: [
                        { id: 'fb-h1', title: 'Acoustic Guitar – Yamaha', description: 'Well maintained, comes with bag and picks.', price: 3500, isFree: false, condition: 'good', images: ['https://images.unsplash.com/photo-1510915361894-db8b60106cb1?w=400&h=300&fit=crop'], sellerName: 'Harsh V.', sellerYear: '4th Year' },
